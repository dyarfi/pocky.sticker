...
class SubDistrict extends Admin_Controller {
    ...
    public function index() {
	    ...
	    // Set our Grocery CRUD
            ...
            // Set tables
            $crud->set_table('tbl_sub_districts');
            // Set CRUD subject
            $crud->set_subject('Sub District');                            
            // Set table relation
            $crud->set_relation('urban_district_id','tbl_urban_districts','name');
            // Set column
    ...
    private function load($crud, $nav) {
        ...
        if ($crud->getState() == 'list') {
            ...
            $output->page_title = 'Sub District Listings';
            // Set Main Template
